...
// loadUsers() вызывается в app.vue при инициализации приложения
// Не нужно вызывать здесь, чтобы избежать race conditions
...
const baseNavigation = [
  ...
  { name: 'Черновики', href: '/drafts', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
...
// Административная навигация для модераторов
const adminNavigation = [
  { name: 'Белые списки', href: '/admin/whitelist', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' }
]

// Вычисляемая навигация в зависимости от роли пользователя
const navigation = computed(() => {
  const nav = [...baseNavigation]
  
  // Добавляем административные пункты для модераторов
  if (auth.isModerator) {
